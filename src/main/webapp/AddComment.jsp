...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/pranav","root","12345");
	...
	int uid=Integer.parseInt(request.getParameter("uid"));
		...
		PreparedStatement ps4=con.prepareStatement("insert into usercomment(cid,comment,uid) values(?,?,?)");
		ps4.setInt(1,cid);
...
<div style="padding:30px;">
	...
	<%
	 ...
	 %>
	 <span style="font-size:20px; font-weight:bold;" id="like<%=rs.getInt("pid") %>">0<span>Likes</span></span>
	 <% 
	}
